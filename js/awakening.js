/* =========================================================
   ...
   The player never sees these classifications.
========================================================= */
...
const story = [
...

    {
        ...
        text: `
            ...
            <p>
                The memory is not finished with you.
            </p>
...
function recordChoice(choice) {
    ...
    if (!gameState.feelings[choice.essence][choice.feeling]) {
...
function determineEssence() {
    ...
    /*
        Tie-breaking will be expanded later.

        For now, the first tied Essence is selected.
        We will replace this with the final tie-breaker system
        once the five stories are finalized.
    */
...
function determineTriggerFeeling(essence) {
    ...
    const feelings = gameState.feelings[essence];
...
function revealEssence() {
    ...
    const triggerFeeling = determineTriggerFeeling(essence);
    ...
    resultContent.innerHTML = `
        ...
        <div class="result-value">
            ${essenceData[essence].core} — ${triggerFeeling}
        </div>
